...
class BasePlotter(ABC):
    ...
    def get_theme_layout(self) -> Dict[str, Any]:
        ...
        return {
            'background_color': style_config.get('colors', {}).get('background', '#FFFFFF'),
    ...
    def add_common_layout(self, fig: go.Figure, title: str, x_title: str, y_title: str):
        ...
        dimensions = plot_config.dimensions
        height = dimensions.height
        width = dimensions.width
        
        # Get grid configuration
        grid_config = plot_config.grid
        show_grid = grid_config.show
    ...
    def handle_error(self, error: Exception, context: str = ""):
        ...
        return self.error_handler.handle_plot_error(error, self.get_plot_type(), context)
