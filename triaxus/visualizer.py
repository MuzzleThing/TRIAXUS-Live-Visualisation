...
class TriaxusVisualizer:
    ...
    def _initialize_plotters(self):
        ...
        for plot_type in plot_types:
            self._plotters[plot_type] = self.factory.create_plotter(plot_type, self.config_manager)
    ...
    def set_theme(self, theme_name: str):
        ...
        if theme_name not in self.config_manager.get_available_themes():
            ...
            raise ValueError(f"Invalid theme: {theme_name}. Available themes: {available_themes}")
        ...
        for plotter in self._plotters.values():
            plotter.config = self.config_manager.get_plot_config(plotter.get_plot_type())
    ...
    def create_plot(self, plot_type: str, data: pd.DataFrame, **kwargs) -> str:
        ...
        try:
            ...
            if output_file:
                ...
                title = kwargs.get('title', f"TRIAXUS {plot_type.replace('_', ' ').title()} Plot")
    ...
    def create_plot_figure(self, plot_type: str, data: pd.DataFrame, **kwargs) -> go.Figure:
        """
        ...
        try:
            ...
            error_message = self.error_handler.handle_plot_error(e, plot_type)
            self.logger.error(f"Failed to create plot figure {plot_type}: {error_message}")
            raise
    ...
    def create_time_series_plot(self, data: pd.DataFrame, variables: Optional[List[str]] = None, **kwargs) -> str:
        """Create a time series plot"""
        return self.create_plot('time_series', data, variables=variables, **kwargs)
    
    def create_depth_profile_plot(self, data: pd.DataFrame, variables: Optional[List[str]] = None, **kwargs) -> str:
    ...
    def create_dashboard(self, data: pd.DataFrame, plot_configs: Dict[str, Dict[str, Any]]) -> str:
        """
    ...
    def get_plot_statistics(self, data: pd.DataFrame, plot_type: str, **kwargs) -> Dict[str, Any]:
    ...
    def create_custom_theme(self, name: str, base_theme: str = 'default', 
        ...
        custom_theme = self.theme_manager.create_custom_theme(name, base_theme, custom_config)
