...
class ContourPlotter(BasePlotter):
    ...
    def _prepare_contour_data(
        ...
        try:
            ...
            self.logger.warning(
                f"Interpolation failed: {e}, using scatter plot fallback"
            )
    ...
    def create_contour_with_scatter(
        ...
        return ContourHelpers.create_contour_with_scatter(
