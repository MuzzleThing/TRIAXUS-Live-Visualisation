...
=======
    ...
    # Import test modules
    from test_time_series_plots import test_time_series_plots
    from test_depth_profile_plots import test_depth_profile_plots
    from test_contour_plots import test_contour_plots
    from test_map_trajectory import test_map_trajectory, test_map_trajectory_extended, test_map_trajectory_different_styles
    from test_theme_functionality import test_theme_functionality
    from test_data_quality import test_data_quality
